define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "deniedIPs",
            "description": "<p>=[] IP Addresses not allowed to access this secret.</p>"
          },
          {
            "group": "Parameter",
            "type": "String[]",
  ...
  {
    "type": "post",
    "url": "/userAgreement/Update",
    "title": "Update User Agreement Policy",
    "version": "0.1.0",
    "name": "Update",
    "group": "UserAgreement",
    "parameter": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>Name of policy.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "version",
            "description": "<p>Version number of policy.</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            ...
            "description": "<p>Date when the policy will be in effect.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "policySummary",
            "description": "<p>Summary of type new updates in policy</p>"
          },
          {
            "group": "Parameter",
            "type": "Date",
            "optional": false,
            "field": "signedOffDate",
            "description": "<p>Date when the policy was approved by the board.</p>"
          },
          {
            "group": "Parameter",
            "type": "Boolean",
            "optional": true,
            "field": "enforcePolicy",
            "description": "<p>Require the user to accept policy again or not.</p>"
          }
        ]
      }
    },
    ...
    "filename": "services/src/domain/userAgreement/commands/update.js",
    "groupTitle": "UserAgreement"
  },
  {
    "0": "p",
    "1": "r",
    ...
    "name": "GetUserDetailsFromHubspot",
    "group": "User",
    "parameter": {
      "fields": {
        "Parameter": [
    ...
    "filename": "projections/src/projections/views/manager/userDetailsHubspot.js",
    "groupTitle": "User"
  },
  {
    "0": "p",
  ...
  },
  {
    ...
    "type": "post",
    "url": "/user/:userId/AcceptInvite",
    "title": "Accept the user agreement policy",
    "version": "0.1.0",
    ...
    "filename": "services/src/domain/user/commands/acceptUserAgreement.js",
    "groupTitle": "Users"
  },
  {
    "0": "p",
  ...
  },
  {
    ...
    "6": "e",
    "type": "get",
    "url": "/userAcceptedPolicyVersions?userId=userId",
    "title": "UserAcceptedPolicyVersions",
    "version": "0.1.0",
    "permission": [
      {
        "name": "Manager"
    ...
    "name": "GetUserAcceptedPolicyVersions",
    "group": "Users",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "type": "String",
            "optional": false,
            "field": "privacyPolicyVersions",
            "description": "<p>Privacy Policy Versions</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "termsOfServiceVersions",
            "description": "<p>Terms Of Service Versions</p>"
          }
        ]
      },
      "examples": [
    ...
    "filename": "projections/src/projections/views/auditlogs/userAcceptedPolicyVersions.js",
    "groupTitle": "Users"
  },
  {
    "0": "p",
